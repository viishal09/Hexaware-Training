...
class Event(DbConn):
    def __init__(self, event_id=None, event_name=None, event_date=None, event_time=None, venue_id=None, total_seats=None, availble_seats=None, ticket_price=None, event_type=None):
